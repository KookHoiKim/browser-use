...
# Changes: Using custom planner prompt in prompts/planner.md
# =============================================================================
...
echo "Note:       Using CUSTOM planner prompt"
echo "Prompt:     $SCRIPT_DIR/prompts/planner.md"
